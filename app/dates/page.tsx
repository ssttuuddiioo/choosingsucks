    ...
    <div className="min-h-screen bg-gradient-primary md:flex md:items-center md:justify-center md:p-4">
      ...
      >
        <div className="space-y-4">
          ...
          <h1 className="text-3xl font-outfit font-bold gradient-text">Date Ideas</h1>
          <p className="text-white/70 text-lg">Coming soon! We're working on making date choices suck less too.</p>
        </div>
