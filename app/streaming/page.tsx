    ...
    <div className="min-h-screen bg-gradient-primary md:flex md:items-center md:justify-center md:p-4">
      ...
      >
        <div className="space-y-4">
          <Tv className="h-16 w-16 mx-auto text-white" />
          <h1 className="text-3xl font-outfit font-bold gradient-text">TV Shows</h1>
          <p className="text-white/70 text-lg">Coming soon! We're working on making TV show choices suck less too.</p>
        </div>
